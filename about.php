        ...
        <div class=" container px-0 xl:px-6" style="width: 100%">
            ...
            <div style="position: relative; display: flex; margin:auto; text-align: center; justify-content:center;">
                <div style="margin: 20px 30px; display:flex; flex-direction: column; gap: 5px;">
                    <a href="assets/img/about/Struktur-DPI-2025.svg" style="padding-top:10px;" target="_blank">
                        <img src="assets/img/about/Struktur-DPI-2025.svg" Class="Bagan" alt="" style="display: flex; margin: auto;">
                    </a>
                    <a href="assets/img/about/Struktur-Non-DPI-2025.svg" target="_blank">
                        <img src="assets/img/about/Struktur-Non-DPI-2025.svg"  Class="Bagan" alt="" style="display: flex; margin: auto;">
                    </a>
                </div>
            </div>
        </div>
